            ...
            {filteredLessons.length === 0 ? (
              ...
              filteredLessons.map((lesson, index) => (
                <button
                  ...
                  className={`w-full text-left p-4 border-b transition-all hover:bg-lila-50 ${selected?.id === lesson.id
                ...
                >
                  <div className="flex items-start space-x-3">
                    <div
                      className={`flex-shrink-0 w-10 h-10 rounded-lg flex items-center justify-center font-bold text-sm ${selected?.id === lesson.id
                    ...
                    <div className="flex-1 min-w-0">
                      <h3
                        className={`font-semibold mb-1 line-clamp-2 ${selected?.id === lesson.id
                          ? "text-lila-800"
                          : "text-gray-800"
                          }`}
                      >
