...
namespace backend_put_together.Migrations
{
    ...
    [Migration("20260128194053_CreateS3StoredObject")]
    partial class CreateS3StoredObject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend_put_together.Domain.Storage.S3StoredFile", b =>
                {
                    ...
                    b.HasIndex("LessonId")
                        .HasDatabaseName("ix_stored_files_lesson_id")
            ...
            modelBuilder.Entity("backend_put_together.Domain.Storage.S3StoredFile", b =>
                {
                    b.HasOne("backend_put_together.Domain.Lessons.Lesson", "Lesson")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_stored_files_lessons_lesson_id");
