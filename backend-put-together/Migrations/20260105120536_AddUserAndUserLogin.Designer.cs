...
namespace backend_put_together.Migrations
{
    ...
    [Migration("20260105120536_AddUserAndUserLogin")]
    partial class AddUserAndUserLogin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_put_together.Domain.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("backend_put_together.Domain.User.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("backend_put_together.Domain.User.UserLogin", b =>
                {
                    b.HasOne("backend_put_together.Domain.User.User", "User")
                        .WithMany("UserLogins")
